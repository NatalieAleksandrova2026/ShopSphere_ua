---
title: "ShopSphere: комплексний аналіз бізнесу глобального онлайн-маркетплейсу"
subtitle: "Фінальний аналітичний звіт"
author: Александрова Наталія
period: "2022–2024"
...
| **Комплект здачі** | цей звіт (report.md / report.docx) + Додаток Б (тексти SQL-запитів) + робоча книга Tableau (.twbx) з дашбордами |
...
*Рисунок 1. Графік "Umsatzentwicklung 2022–2024" з виділеними грудневими піками (місце для вставки).*
...
*Рисунок 14. Bar-графік 4 підгруп New/Repeat × A/B — на момент підготовки звіту графік ще не побудовано: під час роботи в Tableau виникла технічна складність із коректним групуванням чотирьох стовпців на одній осі, роботу тимчасово призупинено (місце для вставки після завершення).*
...
| 14 | Рис. 14 | 8 | Bar-графік 4 підгруп (New/Repeat × A/B) |
